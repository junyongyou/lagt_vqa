    ...
    if checkpoint:
        if metrics == None:
            ...
            if metrics == 'accuracy':
                ...
                mcp_file = os.path.join(result_folder, '{epoch:01d}_{loss:.4f}_{mae:.4f}.h5')
        ...
        # mcp = ModelCheckpoint(mcp_file, save_best_only=False, save_weights_only=True, monitor='loss', verbose=1, mode='min')
