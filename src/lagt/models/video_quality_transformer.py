...
from tensorflow.keras.layers import Dense, Dropout, LayerNormalization, Layer, Lambda
...
class MultiHeadAttention(Layer):
    ...
    def scaled_dot_product_attention(self, query, key, value, mask):
        ...
        # weights0 = tf.nn.softmax(scaled_score, axis=-1)
        if mask is not None:
