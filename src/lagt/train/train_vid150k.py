...
def train_main(args, train_vids=None, test_vids=None):
    ...
    if args['validation'] == 'validation':
        train_generator = VideoClipFeatureGenerator(args['train_file'],
                                                    None,
        ...
        # test_generator = VideoClipFeatureGenerator(args['val_file'],
        #                                            None,
    ...
    evaluation_callback = None# ModelEvaluationGeneratorVQ(test_generator, None)
...
if __name__ == '__main__':
    args = {}
    args['result_folder'] = r'K:\Faglitteratur\VQA\lagt_k150k'

    # The feature file paths must be changed to Resnet50 feature files
    args['train_file'] = r'C:\vq_datasets\k150k\train.csv'
    args['val_file'] = r'C:\vq_datasets\k150k\val.csv'
